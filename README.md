...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/still-lab-89ea#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/still-lab-89ea
```

A live public deployment of this template is available at [https://still-lab-89ea.templates.workers.dev](https://still-lab-89ea.templates.workers.dev)
